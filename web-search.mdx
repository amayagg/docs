---
title: "Web Search"
description: "Use Web Search to automatically find missing product data from online sources. "
---

### **Step 1: Enable Web Search**

Make sure the toggle at the top is switched **on** to activate web search.
